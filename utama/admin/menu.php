...
<li class="nav-item active">
    <a class="nav-link" href="location:utama/admin/index.php">
...
<li class="nav-item">
    ...
    <div id="collapsePages1" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="http://localhost/kasir/utama/admin/masterdata/instansirelasi.php">Instansi Relasi</a>
