...
?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="../exportexcel/exportexcel_barang.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
 ...
 <div class="container-fluid">
    ...
    <div class="card-body">
                ...
                <tbody>
                      ...
                      $data = mysqli_query($koneksi,"select * from masterdata_barang");
                  ...
                  <tr>
                                        ...
                                        <!-- Modal Delete -->
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <!-- Modal Header -->
                                                <div class="modal-header">
                                                <h4 class="modal-title">Hapus Nama Barang?</h4>
                                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                </div>
