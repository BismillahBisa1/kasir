<?php 
require 'functionjenisrelasi.php';
?>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Master Data Jenis Instansi</h1>
                        ...
                        <div class="card shadow mb-4">
                            ...
                            $ambilsemuadatarelasi = mysqli_query($koneksi,"select * from masterdata_jenisrelasi  limit $halaman_awal, $batas"); //mengambil atau mengambil semua data yang ada di stock//
                            $nomor = $halaman_awal+1;
                            while($data= mysqli_fetch_array(($ambilsemuadatarelasi))){ 
                                $ids = $data['id_jenisrelasi'];
                                $nama = $data['nama'];
